namespace bot {
    ...
    export class Bot {
        ...
        constructor(
            ...
            case "BINANCE":
                this.trader = new trader.PerformanceMonitoringTrader( new trader.BinanceTrader(this.binance), this.binance )
                break
            default:
                this.trader = new trader.PerformanceMonitoringTrader( new trader.MockTrader(this.binance), this.binance )
                break
            }
